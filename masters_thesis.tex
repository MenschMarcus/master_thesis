...
\newcommand{\titleFirst}  {Visualizing and Editing the History of}
\newcommand{\titleSecond} {Countries in Time and Space with HistoGlobe}
\newcommand{\submissionDate}{10. June 2016}
% ---------------------------------------------------------------------------
...
\usepackage{enumitem}           % for labelindent in descriptions
...
\renewcommand{\ttdefault}{pcr}{\hyphenchar \font=45}

% define coffeescript language
\lstdefinelanguage{coffeescript}
{
  ...
  morekeywords={             % define keywords
    ...
    in,
    return,
    constructor,              % names of functions
    execute,
    insert
  },
...
% set style for coffeescript language
\lstset{
  language=     coffeescript,         % define the style for coffeescript
...
\titlecontents{section}       [6.7em]  {\addvspace{-0.7em}\large}          {\contentslabel{2.95em}}{} {\titlerule*[0.6pc]{.}\contentspage}
\titlecontents{subsection}    [10.6em] {\addvspace{-0.9em}\normalsize}     {\contentslabel{3.8em}} {} {\titlerule*[0.6pc]{.}\contentspage}
...
\include{chapter/x-titlepage}


%\* TITLE PAGE *\
\cleardoublepage  % ensures abstract is on the right
\include{chapter/x-abstract}
...
\cleardoublepage
\include{chapter/4-extensions}
\cleardoublepage
\include{chapter/5-summary}
