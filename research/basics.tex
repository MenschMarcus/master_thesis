...
\section{Information System} % (fold)
...
\subsection{\emph{Information}} % (fold)
...
% subsection definition_of_information (end)
...
% subsection types (end)

% section information_system (end)


\section{Geographic Information System} % (fold)
...
\subsection{\emph{Geography}} % (fold)
%\label{sub:geography}
...
\subsection{Model of the Earth} % (fold)
...
% subsection model_of_the_earth (end)


\subsection{Map Projections} % (fold)
...
% subsection map_projections (end)


\subsection{Geographic Data Models} % (fold)
...
% section geographic_information_system (end)


\section{Historical Geographic Information System} % (fold)
...
% section historical_geographic_information_system (end)
