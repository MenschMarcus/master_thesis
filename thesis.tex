...
% thesis details
% ---------------------------------------------------------------------------
\newcommand{\submissionDate}{9. May 2016}
\newcommand{\titleFirst}{Modelling Changes in Time and Space}
\newcommand{\titleSecond}{in an Historical Geographic Information System}
\newcommand{\titleThird}{~}
% ---------------------------------------------------------------------------
