...
\begin{description}[labelindent=1.53em]
  ...
  \item[$^3$] History is the study of our past, to understand the present and reason about the future. Its main ideas are introduced in section \ref{sub:history}.
...
Alike many other fields in humanities, history is ``an ideal field for thinking long and hard about important questions''
\cite{ahaFiveCs}.
