...
consitnue here
extension of ebstdm
  combination of event- and entity-based approach
  direct derivation of historical relationships between geo-objects
  linear timeline
  supports discrete and continuous time, relative and absolute time
  support change and movement
  can tell the history of a geo-object
