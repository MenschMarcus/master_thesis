...
\begin{longtable}{m{1.2cm} m{0.95cm} m{0.95cm} m{0.95cm} m{6.0cm} m{2.3cm}}
  ...
  % TODO: introduce T as territory that is used like a temporary Area with exactly that territory
