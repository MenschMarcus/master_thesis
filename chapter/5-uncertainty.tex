...
% ------------------------------------------------------------------------------
\subsubsection{Extension of the Hivent model} % (fold)
...
% subsubsection extension_of_the_hivent_model (end)

% ------------------------------------------------------------------------------
\subsubsection{Extension of the Area model} % (fold)
...
% subsubsection extension_of_the_area_model (end)
