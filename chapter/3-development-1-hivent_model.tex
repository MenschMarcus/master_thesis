...
%  For modelling the shapes of countries, the vector model is appropriate, because it is scale-independent and represents the real world very well. The territory of a country can be represented by a polypolygon. It consists of a set of cohesive parts of the territory, described by polygons. Each of these territorial parts contains of a eitehr interior borders or coastlines, represented by polylines which themselves consist of an ordered set of border points in gps coordinates.
% speciality: enclaves and exclaves
% They can represent enclaves, i.e. territories inside the territory of a country
